                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="comment" class="form-control" rows="3" placeholder="กรอกที่นี่..." style="height: 99px;" disabled></textarea>
                                                    </div>
                                                </div>
                                                {{-- เอกสารประกอบการลา --}}
                                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="" method="">
                                                ...
                                                <input type="submit" name="" id="" class="btn btn-primary" placeholder="save">
                                            </form>
