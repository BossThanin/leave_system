                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('leave-form.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="employee_name" name="employee_name" class="form-control select2" style="width: 100%;">
                                                                    @foreach ($employees as $employee)
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="leavetype_id" class="form-control select2"
                                                                    style="width: 100%;">
                                                                    @foreach ($leavetypes as $leavetype)
                                                                        <option value="{{ $leavetype->id }}">
                                                                            {{ $leavetype->leavetype_name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- อัพโหลดไฟล์หลักฐาน 2 -->
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="form-group">
                                                                <label for="image">อัพโหลดไฟล์หลักฐาน 2</label>
                                                                <div class="input-group">
                                                                    <div class="custom-file">
                                                                        <input type="file" name="image"
                                                                            accept="image/*" maxlength="2097152"
                                    ...
                                    {{-- เลือด Project manager --}}
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title"><i class="fas fa-users"></i>เลือก Project manager</h3>
                                                </div>
                                                <div class="card-body">
                                                    <!-- รหัสพนักงาน -->
                                                    <div class="row">
